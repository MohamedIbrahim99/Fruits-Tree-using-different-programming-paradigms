...
class namePrinter{
public :
	void printData(string name, int weight){cout << name << weight;}
};
...
public:
    ...
    void printData(){n.printData("cherries", weight);}
};
